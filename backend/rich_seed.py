...
TICKETS = [
  ...
  ("Data not syncing between mobile and web",
   ...
   "high", cat_technical, "in_progress",
   None),
  ...
  ("Need ability to add internal notes on tickets",
   ...
   "medium", cat_general, "in_progress",
   None),
